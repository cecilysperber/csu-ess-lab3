...
```
## Answer: Scaling by population gives more context to compare the severity by state. When looking at one state, you have no reference point to analyze it. 
...
```
## Answer: Once completed describe the differences in the plots and what they mean about the spatial patterns seen with COVID impacts